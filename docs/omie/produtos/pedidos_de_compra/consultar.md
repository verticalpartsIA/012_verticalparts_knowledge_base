...
Use este metodo quando a operacao desejada corresponder ao metodo oficial `Consultar` do servico `Pedidos de Compra`.
...
- Automatizar a operacao `Consultar` no contexto do servico `Pedidos de Compra`.
...
### Quando devo usar o metodo Consultar?

Necessita validacao.
### Quais campos sao obrigatorios para Consultar?

Necessita validacao.
### Qual endpoint devo chamar para Consultar?

Necessita validacao.
### Que retorno esperar do metodo Consultar?

Necessita validacao.
### Como Consultar se relaciona com Pedidos de Compra?
