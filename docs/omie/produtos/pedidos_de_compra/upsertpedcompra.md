...
Use este metodo quando a operacao desejada corresponder ao metodo oficial `UpsertPedCompra` do servico `Pedidos de Compra`.
...
- Automatizar a operacao `UpsertPedCompra` no contexto do servico `Pedidos de Compra`.
...
### Quando devo usar o metodo UpsertPedCompra?

Necessita validacao.
### Quais campos sao obrigatorios para UpsertPedCompra?

Necessita validacao.
### Qual endpoint devo chamar para UpsertPedCompra?

Necessita validacao.
### Que retorno esperar do metodo UpsertPedCompra?

Necessita validacao.
### Como UpsertPedCompra se relaciona com Pedidos de Compra?
