...
Use este metodo quando a operacao desejada corresponder ao metodo oficial `ExcluirPedCompra` do servico `Pedidos de Compra`.
...
- Automatizar a operacao `ExcluirPedCompra` no contexto do servico `Pedidos de Compra`.
...
### Quando devo usar o metodo ExcluirPedCompra?

Necessita validacao.
### Quais campos sao obrigatorios para ExcluirPedCompra?

Necessita validacao.
### Qual endpoint devo chamar para ExcluirPedCompra?

Necessita validacao.
### Que retorno esperar do metodo ExcluirPedCompra?

Necessita validacao.
### Como ExcluirPedCompra se relaciona com Pedidos de Compra?
