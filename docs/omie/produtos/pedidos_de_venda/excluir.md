...
Use este metodo quando a operacao desejada corresponder ao metodo oficial `Excluir` do servico `Pedidos de Venda`.
...
- Automatizar a operacao `Excluir` no contexto do servico `Pedidos de Venda`.
...
Necessita validacao.
### Como Excluir se relaciona com Pedidos de Venda?
