...
Use este metodo quando a operacao desejada corresponder ao metodo oficial `ExcluirPedido` do servico `Pedidos de Venda`.
...
Excluir pedido de venda de produto Parâmetros: Retorno pvpExcluirResponse : Exemplo: Teste agora mesmo
...
- Automatizar a operacao `ExcluirPedido` no contexto do servico `Pedidos de Venda`.
...
### Quando devo usar o metodo ExcluirPedido?

Necessita validacao.
### Quais campos sao obrigatorios para ExcluirPedido?

Necessita validacao.
### Qual endpoint devo chamar para ExcluirPedido?

Necessita validacao.
### Que retorno esperar do metodo ExcluirPedido?

Necessita validacao.
### Como ExcluirPedido se relaciona com Pedidos de Venda?
