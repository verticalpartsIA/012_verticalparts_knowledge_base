...
Use este metodo quando a operacao desejada corresponder ao metodo oficial `AssociarCodIntOS` do servico `Ordens de Serviço Faturamento`.
...
Parâmetros: Retorno osAssociarCodIntResponse : Exemplo: Teste agora mesmo
...
- Automatizar a operacao `AssociarCodIntOS` no contexto do servico `Ordens de Serviço Faturamento`.
...
### Quando devo usar o metodo AssociarCodIntOS?

Necessita validacao.
### Quais campos sao obrigatorios para AssociarCodIntOS?

Necessita validacao.
### Qual endpoint devo chamar para AssociarCodIntOS?

Necessita validacao.
### Que retorno esperar do metodo AssociarCodIntOS?

Necessita validacao.
### Como AssociarCodIntOS se relaciona com Ordens de Serviço Faturamento?
