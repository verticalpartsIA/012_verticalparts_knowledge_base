...
Use este metodo quando a operacao desejada corresponder ao metodo oficial `ConsultarContaPagar` do servico `Contas a Pagar Lançamentos`.
...
- Automatizar a operacao `ConsultarContaPagar` no contexto do servico `Contas a Pagar Lançamentos`.
