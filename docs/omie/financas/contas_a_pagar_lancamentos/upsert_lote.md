...
Use este metodo quando a operacao desejada corresponder ao metodo oficial `UPSERT` do servico `Contas a Pagar Lançamentos`.
...
- Automatizar a operacao `UPSERT` no contexto do servico `Contas a Pagar Lançamentos`.
