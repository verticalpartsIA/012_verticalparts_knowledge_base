...
Use este metodo quando a operacao desejada corresponder ao metodo oficial `UpsertContaPagarPorLote` do servico `Contas a Pagar Lançamentos`.
...
- Automatizar a operacao `UpsertContaPagarPorLote` no contexto do servico `Contas a Pagar Lançamentos`.
