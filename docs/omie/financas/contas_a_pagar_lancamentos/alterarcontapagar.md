...
Use este metodo quando a operacao desejada corresponder ao metodo oficial `AlterarContaPagar` do servico `Contas a Pagar Lançamentos`.
...
- Automatizar a operacao `AlterarContaPagar` no contexto do servico `Contas a Pagar Lançamentos`.
