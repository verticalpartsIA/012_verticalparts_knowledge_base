...
Use este metodo quando a operacao desejada corresponder ao metodo oficial `UpsertContaPagar` do servico `Contas a Pagar Lançamentos`.
...
- Automatizar a operacao `UpsertContaPagar` no contexto do servico `Contas a Pagar Lançamentos`.
