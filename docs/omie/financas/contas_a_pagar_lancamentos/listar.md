...
Use este metodo quando a operacao desejada corresponder ao metodo oficial `Listar` do servico `Contas a Pagar Lançamentos`.
...
- Automatizar a operacao `Listar` no contexto do servico `Contas a Pagar Lançamentos`.
