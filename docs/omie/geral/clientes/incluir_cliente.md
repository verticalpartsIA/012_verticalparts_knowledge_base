---
title: "IncluirCliente - Omie Geral Clientes"
...
---
        ...
        Inclui um novo cliente, fornecedor ou transportadora no cadastro central do Omie. Este documento foi estruturado para LLMs, RAG e GraphRAG, nao como tutorial humano isolado.

        ## Quando utilizar

        Utilize `IncluirCliente` para criar um novo cadastro quando a integracao sabe que o registro ainda nao existe.

        ## Quando NÃO utilizar

        Nao utilize `IncluirCliente` para atualizar cadastro existente ou executar sincronizacao idempotente sem controle previo. Quando houver duvida, a LLM deve responder que a decisao necessita validacao.
...
- `UpsertClienteCpfCnpj`
        ...
        - Metodo documentado oficialmente: `IncluirCliente`.
  ...
  "param": [
    {
      ...
      "email": "contato@cliente-ficticio.example"
        ...
        curl -X POST "https://app.omie.com.br/api/v1/geral/clientes/" \
          ...
          -d '{"call": "IncluirCliente", "param": [{"codigo_cliente_integracao": "CLI-FICTICIO-001", "razao_social": "Cliente Ficticio Ltda", "nome_fantasia": "Cliente Ficticio", "cnpj_cpf": "00.000.000/0001-00", "email": "contato@cliente-ficticio.example"}]}'
        ```
        ...
        payload = {'call': 'IncluirCliente', 'param': [{'codigo_cliente_integracao': 'CLI-FICTICIO-001', 'razao_social': 'Cliente Ficticio Ltda', 'nome_fantasia': 'Cliente Ficticio', 'cnpj_cpf': '00.000.000/0001-00', 'email': 'contato@cliente-ficticio.example'}]}
  ...
  "param": [
    {
      ...
      "email": "contato@cliente-ficticio.example"
        ...
        ```pascal
        // Exemplo ficticio: montar o JSON com call="IncluirCliente" e param=[...].
        ...
        ```json
        {
          ...
          "jsonBody": {"call": "IncluirCliente", "param": [{"codigo_cliente_integracao": "CLI-FICTICIO-001", "razao_social": "Cliente Ficticio Ltda", "nome_fantasia": "Cliente Ficticio", "cnpj_cpf": "00.000.000/0001-00", "email": "contato@cliente-ficticio.example"}]}
        }
        ```
...
Use as secoes de payload, regras e restricoes deste arquivo para inclui um novo cliente, fornecedor ou transportadora no cadastro central do omie. A fonte oficial documenta o metodo `IncluirCliente`, mas campos condicionais e comportamento em producao devem ser validados em ambiente autorizado. Exemplos sao ficticios.
...
Use as secoes de payload, regras e restricoes deste arquivo para inclui um novo cliente, fornecedor ou transportadora no cadastro central do omie. A fonte oficial documenta o metodo `IncluirCliente`, mas campos condicionais e comportamento em producao devem ser validados em ambiente autorizado. Exemplos sao ficticios.
        ...
        - Como escolher `IncluirCliente`?
        - Quando `IncluirCliente` e melhor que os metodos relacionados?
