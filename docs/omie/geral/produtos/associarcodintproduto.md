---
title: "AssociarCodIntProduto"
service: "Produtos"
domain: "omie.geral"
resource: "Produtos"
method: "AssociarCodIntProduto"
...
Use este metodo quando a operacao desejada corresponder ao metodo oficial `AssociarCodIntProduto` do servico `Produtos`.
...
- Automatizar a operacao `AssociarCodIntProduto` no contexto do servico `Produtos`.
...
### Quando devo usar o metodo AssociarCodIntProduto?

Necessita validacao.
### Quais campos sao obrigatorios para AssociarCodIntProduto?

Necessita validacao.
### Qual endpoint devo chamar para AssociarCodIntProduto?

Necessita validacao.
### Que retorno esperar do metodo AssociarCodIntProduto?

Necessita validacao.
### Como AssociarCodIntProduto se relaciona com Produtos?
