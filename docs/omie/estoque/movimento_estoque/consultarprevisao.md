---
title: "ConsultarPrevisao"
service: "Movimento Estoque"
domain: "omie.estoque"
resource: "Movimento Estoque"
method: "ConsultarPrevisao"
endpoint: "https://app.omie.com.br/api/v1/estoque/movestoque/"
http_method: "POST"
version: "v1"
entity: "Movimento Estoque"
related_entities: []
related_methods: []
permissions: "Necessita validacao"
complexity: "media"
status: "Documentado automaticamente/a validar"
source: "https://app.omie.com.br/api/v1/estoque/movestoque/"
...
Use este metodo quando a operacao desejada corresponder ao metodo oficial `ConsultarPrevisao` do servico `Movimento Estoque`.
...
Parâmetros: Retorno epPrevisaoResponse : Exemplo: Teste agora mesmo
...
- Automatizar a operacao `ConsultarPrevisao` no contexto do servico `Movimento Estoque`.
...
### Quando devo usar o metodo ConsultarPrevisao?

Necessita validacao.
### Quais campos sao obrigatorios para ConsultarPrevisao?

Necessita validacao.
### Qual endpoint devo chamar para ConsultarPrevisao?

Necessita validacao.
### Que retorno esperar do metodo ConsultarPrevisao?

Necessita validacao.
### Como ConsultarPrevisao se relaciona com Movimento Estoque?
