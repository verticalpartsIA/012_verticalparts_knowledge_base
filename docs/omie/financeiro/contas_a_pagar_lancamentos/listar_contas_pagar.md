...
questions: 20
use_cases:
  - "Automatizar ListarContasPagar em Contas a Pagar"
...
Documentar o metodo oficial `ListarContasPagar` do servico `Contas a Pagar - Lançamentos` para consulta por LLMs, RAG e automacoes da VerticalParts.

## Quando utilizar

Use este metodo quando a operacao financeira desejada corresponder ao metodo oficial `ListarContasPagar` no endpoint de Contas a Pagar.
...
- Automatizar a operacao `ListarContasPagar` em rotinas financeiras.
...
```php
$payload = {"call": "ListarContasPagar", "param": [{"exemplo": "ficticio"}]};
...
```java
String payload = "{   \"call\": \"ListarContasPagar\",   \"param\": [     {       \"codigo_lancamento_integracao\": \"PAG-FICTICIO-001\",       \"codigo_cliente_fornecedor\": 123456,       \"data_vencimento\": \"31/12/2026\",       \"valor_documento\": 100.0,       \"codigo_categoria\": \"9.99.99\",       \"observacao\": \"Exemplo ficticio gerado pela Factory\"     }   ] }";
...
### 1. Quando devo usar o metodo ListarContasPagar?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 2. Quais campos sao obrigatorios para ListarContasPagar?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 3. Qual endpoint devo chamar para ListarContasPagar?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 4. Que retorno esperar do metodo ListarContasPagar?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 5. Como ListarContasPagar se relaciona com Contas a Pagar - Lançamentos?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 6. ListarContasPagar serve para fornecedor?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 7. ListarContasPagar altera algum movimento financeiro?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 8. ListarContasPagar exige categoria financeira?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 9. Posso usar ListarContasPagar com dados ficticios em teste?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 10. Quais erros comuns acontecem em ListarContasPagar?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 11. Como validar payload antes de chamar ListarContasPagar?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 12. ListarContasPagar pode ser usado em lote?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 13. ListarContasPagar depende de banco ou conta corrente?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 14. Como uma LLM escolhe ListarContasPagar?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 15. Quando nao devo usar ListarContasPagar?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 16. ListarContasPagar substitui consulta de movimentos financeiros?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 17. ListarContasPagar precisa de codigo Omie?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 18. ListarContasPagar precisa de codigo interno?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 19. Onde encontro a fonte oficial de ListarContasPagar?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 20. Quais tags RAG ajudam a recuperar ListarContasPagar?
...
- ListarContasPagar serve para fornecedor?
- ListarContasPagar altera algum movimento financeiro?
- ListarContasPagar exige categoria financeira?
- Posso usar ListarContasPagar com dados ficticios em teste?
- Quais erros comuns acontecem em ListarContasPagar?
- Como validar payload antes de chamar ListarContasPagar?
- ListarContasPagar pode ser usado em lote?
- ListarContasPagar depende de banco ou conta corrente?
- Como uma LLM escolhe ListarContasPagar?
- Quando nao devo usar ListarContasPagar?
- ListarContasPagar substitui consulta de movimentos financeiros?
- ListarContasPagar precisa de codigo Omie?
- ListarContasPagar precisa de codigo interno?
- Onde encontro a fonte oficial de ListarContasPagar?
- Quais tags RAG ajudam a recuperar ListarContasPagar?
