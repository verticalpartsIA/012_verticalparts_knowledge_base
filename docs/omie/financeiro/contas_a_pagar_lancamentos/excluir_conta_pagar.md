...
questions: 20
use_cases:
  - "Automatizar ExcluirContaPagar em Contas a Pagar"
...
Documentar o metodo oficial `ExcluirContaPagar` do servico `Contas a Pagar - Lançamentos` para consulta por LLMs, RAG e automacoes da VerticalParts.

## Quando utilizar

Use este metodo quando a operacao financeira desejada corresponder ao metodo oficial `ExcluirContaPagar` no endpoint de Contas a Pagar.
...
- Automatizar a operacao `ExcluirContaPagar` em rotinas financeiras.
...
```php
$payload = {"call": "ExcluirContaPagar", "param": [{"exemplo": "ficticio"}]};
...
```java
String payload = "{   \"call\": \"ExcluirContaPagar\",   \"param\": [     {       \"codigo_lancamento_integracao\": \"PAG-FICTICIO-001\",       \"codigo_cliente_fornecedor\": 123456,       \"data_vencimento\": \"31/12/2026\",       \"valor_documento\": 100.0,       \"codigo_categoria\": \"9.99.99\",       \"observacao\": \"Exemplo ficticio gerado pela Factory\"     }   ] }";
...
### 1. Quando devo usar o metodo ExcluirContaPagar?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 2. Quais campos sao obrigatorios para ExcluirContaPagar?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 3. Qual endpoint devo chamar para ExcluirContaPagar?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 4. Que retorno esperar do metodo ExcluirContaPagar?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 5. Como ExcluirContaPagar se relaciona com Contas a Pagar - Lançamentos?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 6. ExcluirContaPagar serve para fornecedor?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 7. ExcluirContaPagar altera algum movimento financeiro?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 8. ExcluirContaPagar exige categoria financeira?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 9. Posso usar ExcluirContaPagar com dados ficticios em teste?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 10. Quais erros comuns acontecem em ExcluirContaPagar?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 11. Como validar payload antes de chamar ExcluirContaPagar?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 12. ExcluirContaPagar pode ser usado em lote?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 13. ExcluirContaPagar depende de banco ou conta corrente?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 14. Como uma LLM escolhe ExcluirContaPagar?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 15. Quando nao devo usar ExcluirContaPagar?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 16. ExcluirContaPagar substitui consulta de movimentos financeiros?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 17. ExcluirContaPagar precisa de codigo Omie?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 18. ExcluirContaPagar precisa de codigo interno?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 19. Onde encontro a fonte oficial de ExcluirContaPagar?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 20. Quais tags RAG ajudam a recuperar ExcluirContaPagar?
...
- ExcluirContaPagar serve para fornecedor?
- ExcluirContaPagar altera algum movimento financeiro?
- ExcluirContaPagar exige categoria financeira?
- Posso usar ExcluirContaPagar com dados ficticios em teste?
- Quais erros comuns acontecem em ExcluirContaPagar?
- Como validar payload antes de chamar ExcluirContaPagar?
- ExcluirContaPagar pode ser usado em lote?
- ExcluirContaPagar depende de banco ou conta corrente?
- Como uma LLM escolhe ExcluirContaPagar?
- Quando nao devo usar ExcluirContaPagar?
- ExcluirContaPagar substitui consulta de movimentos financeiros?
- ExcluirContaPagar precisa de codigo Omie?
- ExcluirContaPagar precisa de codigo interno?
- Onde encontro a fonte oficial de ExcluirContaPagar?
- Quais tags RAG ajudam a recuperar ExcluirContaPagar?
