...
questions: 20
use_cases:
  - "Automatizar Listar em Contas a Pagar"
...
Documentar o metodo oficial `Listar` do servico `Contas a Pagar - Lançamentos` para consulta por LLMs, RAG e automacoes da VerticalParts.

## Quando utilizar

Use este metodo quando a operacao financeira desejada corresponder ao metodo oficial `Listar` no endpoint de Contas a Pagar.
...
- Automatizar a operacao `Listar` em rotinas financeiras.
...
```php
$payload = {"call": "Listar", "param": [{"exemplo": "ficticio"}]};
...
```java
String payload = "{   \"call\": \"Listar\",   \"param\": [     {       \"codigo_lancamento_integracao\": \"PAG-FICTICIO-001\",       \"codigo_cliente_fornecedor\": 123456,       \"data_vencimento\": \"31/12/2026\",       \"valor_documento\": 100.0,       \"codigo_categoria\": \"9.99.99\",       \"observacao\": \"Exemplo ficticio gerado pela Factory\"     }   ] }";
...
### 1. Quando devo usar o metodo Listar?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 2. Quais campos sao obrigatorios para Listar?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 3. Qual endpoint devo chamar para Listar?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 4. Que retorno esperar do metodo Listar?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 5. Como Listar se relaciona com Contas a Pagar - Lançamentos?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 6. Listar serve para fornecedor?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 7. Listar altera algum movimento financeiro?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 8. Listar exige categoria financeira?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 9. Posso usar Listar com dados ficticios em teste?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 10. Quais erros comuns acontecem em Listar?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 11. Como validar payload antes de chamar Listar?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 12. Listar pode ser usado em lote?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 13. Listar depende de banco ou conta corrente?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 14. Como uma LLM escolhe Listar?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 15. Quando nao devo usar Listar?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 16. Listar substitui consulta de movimentos financeiros?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 17. Listar precisa de codigo Omie?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 18. Listar precisa de codigo interno?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 19. Onde encontro a fonte oficial de Listar?

Resposta: Necessita validacao contra a fonte oficial Omie.

### 20. Quais tags RAG ajudam a recuperar Listar?
...
- Como Listar se relaciona com Contas a Pagar - Lançamentos?
- Listar serve para fornecedor?
- Listar altera algum movimento financeiro?
- Listar exige categoria financeira?
- Posso usar Listar com dados ficticios em teste?
- Quais erros comuns acontecem em Listar?
- Como validar payload antes de chamar Listar?
- Listar pode ser usado em lote?
- Listar depende de banco ou conta corrente?
- Como uma LLM escolhe Listar?
- Quando nao devo usar Listar?
- Listar substitui consulta de movimentos financeiros?
- Listar precisa de codigo Omie?
- Listar precisa de codigo interno?
- Onde encontro a fonte oficial de Listar?
- Quais tags RAG ajudam a recuperar Listar?
