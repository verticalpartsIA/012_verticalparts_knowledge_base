...
chunk_id: "UpsertClientesPorLote.contrato"
...
# Chunk UpsertClientesPorLote - contrato

Este chunk concentra payload, campos obrigatorios, campos opcionais e retorno para o metodo `UpsertClientesPorLote` do servico `ClientesCadastro`.
