...
chunk_id: "ListarClientes.identidade"
...
# Chunk ListarClientes - identidade

Este chunk concentra identidade, YAML, endpoint, metodo, dominio e status para o metodo `ListarClientes` do servico `ClientesCadastro`.
