...
chunk_id: "ConsultarCliente.operacao"
...
# Chunk ConsultarCliente - operacao

Este chunk concentra quando usar, quando nao usar, regras, validacoes e restricoes para o metodo `ConsultarCliente` do servico `ClientesCadastro`.
