---
source_path: "docs/omie/geral/clientes/listar_clientes_resumido.md"
chunk_id: "ListarClientesResumido.operacao"
...
# Chunk ListarClientesResumido - operacao

Este chunk concentra quando usar, quando nao usar, regras, validacoes e restricoes para o metodo `ListarClientesResumido` do servico `ClientesCadastro`.

Metodo oficial: `ListarClientesResumido`.
Endpoint oficial: `https://app.omie.com.br/api/v1/geral/clientes/`.
Entrada oficial: `clientes_list_request`.
Retorno oficial: `clientes_list_response`.
Status: Documentado oficialmente / Necessita validacao em integracao.

Uso recomendado: pesquisar cadastros com menor volume de campos.

Nao usar para: obter dados fiscais, endereco completo ou payload integral do cadastro.
