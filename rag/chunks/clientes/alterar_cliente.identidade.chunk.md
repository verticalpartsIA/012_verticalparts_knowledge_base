...
chunk_id: "AlterarCliente.identidade"
...
# Chunk AlterarCliente - identidade

Este chunk concentra identidade, YAML, endpoint, metodo, dominio e status para o metodo `AlterarCliente` do servico `ClientesCadastro`.
