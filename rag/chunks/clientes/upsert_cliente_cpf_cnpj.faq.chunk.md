...
chunk_id: "UpsertClienteCpfCnpj.faq"
...
# Chunk UpsertClienteCpfCnpj - faq

Este chunk concentra FAQ, perguntas naturais, tags e uso por LLM para o metodo `UpsertClienteCpfCnpj` do servico `ClientesCadastro`.
