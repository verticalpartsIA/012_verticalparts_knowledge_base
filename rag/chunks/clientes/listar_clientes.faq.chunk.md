...
# Chunk ListarClientes - faq

Este chunk concentra FAQ, perguntas naturais, tags e uso por LLM para o metodo `ListarClientes` do servico `ClientesCadastro`.
