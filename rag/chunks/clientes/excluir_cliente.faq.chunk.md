...
# Chunk ExcluirCliente - faq

Este chunk concentra FAQ, perguntas naturais, tags e uso por LLM para o metodo `ExcluirCliente` do servico `ClientesCadastro`.
