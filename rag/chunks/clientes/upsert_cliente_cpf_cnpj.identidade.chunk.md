...
chunk_id: "UpsertClienteCpfCnpj.identidade"
...
# Chunk UpsertClienteCpfCnpj - identidade

Este chunk concentra identidade, YAML, endpoint, metodo, dominio e status para o metodo `UpsertClienteCpfCnpj` do servico `ClientesCadastro`.
