...
chunk_id: "ListarClientesResumido.identidade"
...
# Chunk ListarClientesResumido - identidade

Este chunk concentra identidade, YAML, endpoint, metodo, dominio e status para o metodo `ListarClientesResumido` do servico `ClientesCadastro`.
