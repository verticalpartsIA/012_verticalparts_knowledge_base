...
chunk_id: "ExcluirCliente.identidade"
...
# Chunk ExcluirCliente - identidade

Este chunk concentra identidade, YAML, endpoint, metodo, dominio e status para o metodo `ExcluirCliente` do servico `ClientesCadastro`.
