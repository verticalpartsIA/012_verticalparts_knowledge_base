...
chunk_id: "UpsertCliente.contrato"
...
# Chunk UpsertCliente - contrato

Este chunk concentra payload, campos obrigatorios, campos opcionais e retorno para o metodo `UpsertCliente` do servico `ClientesCadastro`.
