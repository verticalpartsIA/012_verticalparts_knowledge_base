...
chunk_id: "AssociarCodIntCliente.identidade"
...
# Chunk AssociarCodIntCliente - identidade

Este chunk concentra identidade, YAML, endpoint, metodo, dominio e status para o metodo `AssociarCodIntCliente` do servico `ClientesCadastro`.
