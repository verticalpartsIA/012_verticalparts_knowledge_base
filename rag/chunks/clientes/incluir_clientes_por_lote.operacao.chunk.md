---
source_path: "docs/omie/geral/clientes/incluir_clientes_por_lote.md"
chunk_id: "IncluirClientesPorLote.operacao"
service: "ClientesCadastro"
method: "IncluirClientesPorLote"
endpoint: "https://app.omie.com.br/api/v1/geral/clientes/"
focus: "quando usar, quando nao usar, regras, validacoes e restricoes"
status: "Documentado oficialmente / DEPRECATED / Necessita validacao antes de uso"
embedding_version: 1
---

# Chunk IncluirClientesPorLote - operacao

Este chunk concentra quando usar, quando nao usar, regras, validacoes e restricoes para o metodo `IncluirClientesPorLote` do servico `ClientesCadastro`.

Metodo oficial: `IncluirClientesPorLote`.
Endpoint oficial: `https://app.omie.com.br/api/v1/geral/clientes/`.
Entrada oficial: `clientes_lote_request`.
Retorno oficial: `clientes_lote_response`.
Status: Documentado oficialmente / DEPRECATED / Necessita validacao antes de uso.

Uso recomendado: entender legado ou fluxo existente que ainda utilize inclusao em lote.

Nao usar para: novas integracoes sem aprovacao tecnica, pois a fonte oficial marca o metodo como DEPRECATED.
