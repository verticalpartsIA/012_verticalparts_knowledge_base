...
# Chunk ConsultarCliente - faq

Este chunk concentra FAQ, perguntas naturais, tags e uso por LLM para o metodo `ConsultarCliente` do servico `ClientesCadastro`.
