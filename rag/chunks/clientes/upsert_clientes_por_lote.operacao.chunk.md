---
source_path: "docs/omie/geral/clientes/upsert_clientes_por_lote.md"
chunk_id: "UpsertClientesPorLote.operacao"
...
# Chunk UpsertClientesPorLote - operacao

Este chunk concentra quando usar, quando nao usar, regras, validacoes e restricoes para o metodo `UpsertClientesPorLote` do servico `ClientesCadastro`.

Metodo oficial: `UpsertClientesPorLote`.
...
Uso recomendado: documentar legado ou avaliar fluxo existente de upsert em massa.

Nao usar para: novas integracoes sem validacao, pois a fonte oficial marca o metodo como DEPRECATED.
