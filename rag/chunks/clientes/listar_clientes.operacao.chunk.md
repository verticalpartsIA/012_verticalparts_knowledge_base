---
source_path: "docs/omie/geral/clientes/listar_clientes.md"
chunk_id: "ListarClientes.operacao"
...
# Chunk ListarClientes - operacao

Este chunk concentra quando usar, quando nao usar, regras, validacoes e restricoes para o metodo `ListarClientes` do servico `ClientesCadastro`.

Metodo oficial: `ListarClientes`.
Endpoint oficial: `https://app.omie.com.br/api/v1/geral/clientes/`.
Entrada oficial: `clientes_list_request`.
Retorno oficial: `clientes_listfull_response`.
Status: Documentado oficialmente / Necessita validacao em integracao.

Uso recomendado: sincronizar, auditar ou paginar cadastros com maior riqueza de dados.

Nao usar para: consultar um unico cadastro conhecido ou usar retorno resumido quando campos completos forem desnecessarios.
