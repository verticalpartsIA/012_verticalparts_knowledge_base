...
chunk_id: "UpsertClienteCpfCnpj.contrato"
...
# Chunk UpsertClienteCpfCnpj - contrato

Este chunk concentra payload, campos obrigatorios, campos opcionais e retorno para o metodo `UpsertClienteCpfCnpj` do servico `ClientesCadastro`.
