...
chunk_id: "ConsultarCliente.identidade"
...
# Chunk ConsultarCliente - identidade

Este chunk concentra identidade, YAML, endpoint, metodo, dominio e status para o metodo `ConsultarCliente` do servico `ClientesCadastro`.
