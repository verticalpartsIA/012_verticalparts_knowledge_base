...
chunk_id: "ExcluirCliente.contrato"
...
# Chunk ExcluirCliente - contrato

Este chunk concentra payload, campos obrigatorios, campos opcionais e retorno para o metodo `ExcluirCliente` do servico `ClientesCadastro`.
