...
chunk_id: "AssociarCodIntCliente.contrato"
...
# Chunk AssociarCodIntCliente - contrato

Este chunk concentra payload, campos obrigatorios, campos opcionais e retorno para o metodo `AssociarCodIntCliente` do servico `ClientesCadastro`.
