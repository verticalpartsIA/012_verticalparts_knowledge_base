...
chunk_id: "UpsertCliente.identidade"
...
# Chunk UpsertCliente - identidade

Este chunk concentra identidade, YAML, endpoint, metodo, dominio e status para o metodo `UpsertCliente` do servico `ClientesCadastro`.
