...
chunk_id: "IncluirClientesPorLote.contrato"
...
# Chunk IncluirClientesPorLote - contrato

Este chunk concentra payload, campos obrigatorios, campos opcionais e retorno para o metodo `IncluirClientesPorLote` do servico `ClientesCadastro`.
