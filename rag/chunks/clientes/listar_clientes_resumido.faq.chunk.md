...
chunk_id: "ListarClientesResumido.faq"
...
# Chunk ListarClientesResumido - faq

Este chunk concentra FAQ, perguntas naturais, tags e uso por LLM para o metodo `ListarClientesResumido` do servico `ClientesCadastro`.
