---
source_path: "docs/omie/geral/clientes/incluir_cliente.md"
chunk_id: "IncluirCliente.operacao"
...
# Chunk IncluirCliente - operacao

Este chunk concentra quando usar, quando nao usar, regras, validacoes e restricoes para o metodo `IncluirCliente` do servico `ClientesCadastro`.

Metodo oficial: `IncluirCliente`.
...
Uso recomendado: criar um novo cadastro quando a integracao sabe que o registro ainda nao existe.

Nao usar para: atualizar cadastro existente ou executar sincronizacao idempotente sem controle previo.
