...
chunk_id: "IncluirClientesPorLote.identidade"
service: "ClientesCadastro"
method: "IncluirClientesPorLote"
endpoint: "https://app.omie.com.br/api/v1/geral/clientes/"
focus: "identidade, YAML, endpoint, metodo, dominio e status"
status: "Documentado oficialmente / DEPRECATED / Necessita validacao antes de uso"
embedding_version: 1
---

# Chunk IncluirClientesPorLote - identidade

Este chunk concentra identidade, YAML, endpoint, metodo, dominio e status para o metodo `IncluirClientesPorLote` do servico `ClientesCadastro`.
