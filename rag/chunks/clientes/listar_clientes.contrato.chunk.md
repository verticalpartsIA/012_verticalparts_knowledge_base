...
chunk_id: "ListarClientes.contrato"
...
# Chunk ListarClientes - contrato

Este chunk concentra payload, campos obrigatorios, campos opcionais e retorno para o metodo `ListarClientes` do servico `ClientesCadastro`.
