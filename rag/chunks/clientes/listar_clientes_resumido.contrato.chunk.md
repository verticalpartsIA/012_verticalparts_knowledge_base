...
chunk_id: "ListarClientesResumido.contrato"
...
# Chunk ListarClientesResumido - contrato

Este chunk concentra payload, campos obrigatorios, campos opcionais e retorno para o metodo `ListarClientesResumido` do servico `ClientesCadastro`.
