...
chunk_id: "UpsertClientesPorLote.identidade"
...
# Chunk UpsertClientesPorLote - identidade

Este chunk concentra identidade, YAML, endpoint, metodo, dominio e status para o metodo `UpsertClientesPorLote` do servico `ClientesCadastro`.
