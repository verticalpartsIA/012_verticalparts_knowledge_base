...
chunk_id: "IncluirCliente.identidade"
...
# Chunk IncluirCliente - identidade

Este chunk concentra identidade, YAML, endpoint, metodo, dominio e status para o metodo `IncluirCliente` do servico `ClientesCadastro`.
