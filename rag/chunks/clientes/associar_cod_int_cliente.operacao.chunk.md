---
source_path: "docs/omie/geral/clientes/associar_cod_int_cliente.md"
chunk_id: "AssociarCodIntCliente.operacao"
...
# Chunk AssociarCodIntCliente - operacao

Este chunk concentra quando usar, quando nao usar, regras, validacoes e restricoes para o metodo `AssociarCodIntCliente` do servico `ClientesCadastro`.

Metodo oficial: `AssociarCodIntCliente`.
...
Uso recomendado: vincular um identificador legado ou interno ao codigo de cliente/fornecedor do Omie.

Nao usar para: alterar dados cadastrais amplos ou criar o cadastro completo.
