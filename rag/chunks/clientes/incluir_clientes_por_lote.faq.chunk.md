...
chunk_id: "IncluirClientesPorLote.faq"
service: "ClientesCadastro"
method: "IncluirClientesPorLote"
endpoint: "https://app.omie.com.br/api/v1/geral/clientes/"
focus: "FAQ, perguntas naturais, tags e uso por LLM"
status: "Documentado oficialmente / DEPRECATED / Necessita validacao antes de uso"
embedding_version: 1
---

# Chunk IncluirClientesPorLote - faq

Este chunk concentra FAQ, perguntas naturais, tags e uso por LLM para o metodo `IncluirClientesPorLote` do servico `ClientesCadastro`.
