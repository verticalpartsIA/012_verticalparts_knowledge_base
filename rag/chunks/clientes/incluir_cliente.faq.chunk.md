...
# Chunk IncluirCliente - faq

Este chunk concentra FAQ, perguntas naturais, tags e uso por LLM para o metodo `IncluirCliente` do servico `ClientesCadastro`.
