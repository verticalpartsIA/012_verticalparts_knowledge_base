---
source_path: "docs/omie/geral/clientes/upsert_cliente.md"
chunk_id: "UpsertCliente.operacao"
...
# Chunk UpsertCliente - operacao

Este chunk concentra quando usar, quando nao usar, regras, validacoes e restricoes para o metodo `UpsertCliente` do servico `ClientesCadastro`.

Metodo oficial: `UpsertCliente`.
...
Uso recomendado: sincronizar cadastro de forma idempotente quando existe chave estavel de integracao.

Nao usar para: fluxos que exigem distinguir explicitamente criacao de alteracao.
