---
source_path: "docs/omie/geral/clientes/excluir_cliente.md"
chunk_id: "ExcluirCliente.operacao"
...
# Chunk ExcluirCliente - operacao

Este chunk concentra quando usar, quando nao usar, regras, validacoes e restricoes para o metodo `ExcluirCliente` do servico `ClientesCadastro`.

Metodo oficial: `ExcluirCliente`.
...
Uso recomendado: remover cadastro quando houver decisao operacional validada e ausencia de bloqueios por vinculos.

Nao usar para: desativar logicamente, corrigir dados ou remover registros com documentos e titulos relacionados sem avaliacao.
