---
source_path: "docs/omie/geral/clientes/upsert_cliente_cpf_cnpj.md"
chunk_id: "UpsertClienteCpfCnpj.operacao"
...
# Chunk UpsertClienteCpfCnpj - operacao

Este chunk concentra quando usar, quando nao usar, regras, validacoes e restricoes para o metodo `UpsertClienteCpfCnpj` do servico `ClientesCadastro`.

Metodo oficial: `UpsertClienteCpfCnpj`.
...
Uso recomendado: sincronizar cadastros quando o documento fiscal e a identidade confiavel.

Nao usar para: ambientes com duplicidade cadastral ou documento fiscal nao confiavel.
