...
# Chunk UpsertCliente - faq

Este chunk concentra FAQ, perguntas naturais, tags e uso por LLM para o metodo `UpsertCliente` do servico `ClientesCadastro`.
