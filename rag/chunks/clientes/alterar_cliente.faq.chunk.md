...
# Chunk AlterarCliente - faq

Este chunk concentra FAQ, perguntas naturais, tags e uso por LLM para o metodo `AlterarCliente` do servico `ClientesCadastro`.
