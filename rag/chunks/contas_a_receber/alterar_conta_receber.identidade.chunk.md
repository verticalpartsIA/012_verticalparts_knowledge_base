---
source_path: "docs/omie/financeiro/contas_a_receber/alterar_conta_receber.md"
chunk_id: "AlterarContaReceber.identidade"
...
# Chunk AlterarContaReceber - identidade

Este chunk descreve o método `AlterarContaReceber` do serviço `LancamentoContaReceber` para recuperação RAG. Entrada oficial: `conta_receber_cadastro`. Retorno oficial: `conta_receber_cadastro_response`. Operação: `alteracao`.
...
Estratégia híbrida: usar busca lexical por `AlterarContaReceber`, `conta_receber_cadastro`, código de lançamento, código de integração, baixa, conciliação, categoria e banco; combinar com busca vetorial por intenção de negócio. Reranking deve priorizar método exato, entidade conta a receber, status documentado oficialmente e compatibilidade com a operação solicitada.
