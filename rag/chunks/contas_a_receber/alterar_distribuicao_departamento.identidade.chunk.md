---
source_path: "docs/omie/financeiro/contas_a_receber/alterar_distribuicao_departamento.md"
chunk_id: "AlterarDistribuicaoDepartamento.identidade"
...
# Chunk AlterarDistribuicaoDepartamento - identidade

Este chunk descreve o método `AlterarDistribuicaoDepartamento` do serviço `LancamentoContaReceber` para recuperação RAG. Entrada oficial: `rateio_cadastro`. Retorno oficial: `conta_receber_cadastro_chave`. Operação: `alteracao_rateio_departamento`.
...
Estratégia híbrida: usar busca lexical por `AlterarDistribuicaoDepartamento`, `rateio_cadastro`, código de lançamento, código de integração, baixa, conciliação, categoria e banco; combinar com busca vetorial por intenção de negócio. Reranking deve priorizar método exato, entidade conta a receber, status documentado oficialmente e compatibilidade com a operação solicitada.
