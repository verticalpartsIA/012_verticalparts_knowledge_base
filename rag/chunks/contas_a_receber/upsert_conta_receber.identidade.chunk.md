---
source_path: "docs/omie/financeiro/contas_a_receber/upsert_conta_receber.md"
chunk_id: "UpsertContaReceber.identidade"
...
# Chunk UpsertContaReceber - identidade

Este chunk descreve o método `UpsertContaReceber` do serviço `LancamentoContaReceber` para recuperação RAG. Entrada oficial: `conta_receber_cadastro`. Retorno oficial: `conta_receber_cadastro_response`. Operação: `upsert`.
