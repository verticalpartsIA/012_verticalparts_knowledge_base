---
source_path: "docs/omie/financeiro/contas_a_receber/excluir_conta_receber.md"
chunk_id: "ExcluirContaReceber.identidade"
...
# Chunk ExcluirContaReceber - identidade

Este chunk descreve o método `ExcluirContaReceber` do serviço `LancamentoContaReceber` para recuperação RAG. Entrada oficial: `conta_receber_cadastro_chave`. Retorno oficial: `conta_receber_cadastro_response`. Operação: `exclusao`.
...
Estratégia híbrida: usar busca lexical por `ExcluirContaReceber`, `conta_receber_cadastro_chave`, código de lançamento, código de integração, baixa, conciliação, categoria e banco; combinar com busca vetorial por intenção de negócio. Reranking deve priorizar método exato, entidade conta a receber, status documentado oficialmente e compatibilidade com a operação solicitada.
