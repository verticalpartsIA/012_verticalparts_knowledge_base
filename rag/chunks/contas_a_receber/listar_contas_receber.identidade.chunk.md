---
source_path: "docs/omie/financeiro/contas_a_receber/listar_contas_receber.md"
chunk_id: "ListarContasReceber.identidade"
...
# Chunk ListarContasReceber - identidade

Este chunk descreve o método `ListarContasReceber` do serviço `LancamentoContaReceber` para recuperação RAG. Entrada oficial: `lcrListarRequest`. Retorno oficial: `lcrListarResponse`. Operação: `listagem`.
...
Estratégia híbrida: usar busca lexical por `ListarContasReceber`, `lcrListarRequest`, código de lançamento, código de integração, baixa, conciliação, categoria e banco; combinar com busca vetorial por intenção de negócio. Reranking deve priorizar método exato, entidade conta a receber, status documentado oficialmente e compatibilidade com a operação solicitada.
