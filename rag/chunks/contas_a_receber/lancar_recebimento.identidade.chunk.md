---
source_path: "docs/omie/financeiro/contas_a_receber/lancar_recebimento.md"
chunk_id: "LancarRecebimento.identidade"
...
# Chunk LancarRecebimento - identidade

Este chunk descreve o método `LancarRecebimento` do serviço `LancamentoContaReceber` para recuperação RAG. Entrada oficial: `conta_receber_lancar_recebimento`. Retorno oficial: `conta_receber_lancar_recebimento_resposta`. Operação: `baixa_recebimento`.
