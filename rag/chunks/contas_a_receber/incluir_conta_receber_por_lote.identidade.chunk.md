---
source_path: "docs/omie/financeiro/contas_a_receber/incluir_conta_receber_por_lote.md"
chunk_id: "IncluirContaReceberPorLote.identidade"
...
# Chunk IncluirContaReceberPorLote - identidade

Este chunk descreve o método `IncluirContaReceberPorLote` do serviço `LancamentoContaReceber` para recuperação RAG. Entrada oficial: `conta_receber_lote`. Retorno oficial: `conta_receber_lote_response`. Operação: `inclusao_lote`.
...
Estratégia híbrida: usar busca lexical por `IncluirContaReceberPorLote`, `conta_receber_lote`, código de lançamento, código de integração, baixa, conciliação, categoria e banco; combinar com busca vetorial por intenção de negócio. Reranking deve priorizar método exato, entidade conta a receber, status documentado oficialmente e compatibilidade com a operação solicitada.
